    ...
    <div className="w-full bg-[var(--background)]" ref={counterRef}>
      <div className="w-[90%] grid grid-cols-4 gap-10 md:gap-2 m-auto">
        <div className="col-span-4 md:col-span-1 flex flex-col items-center">
          <img className="w-[60px] h-[60px]" src="/public/image/Countup/student.png" alt="student" />
        ...
        <div className="col-span-4 md:col-span-1 flex flex-col items-center">
          <img className="w-[60px] h-[60px]" src="/public/image/Countup/calendar.png" alt="calendar" />
          <p className="font-bold text-2xl text-[var(--primary)]">
            {counterOn && (
        ...
        <div className="col-span-4 md:col-span-1 flex flex-col items-center">
          <img className="w-[60px] h-[60px]" src="/public/image/Countup/time.png" alt="time" />
          <p className="font-bold text-2xl text-[var(--primary)]">
            {counterOn && (
        ...
        <div className="col-span-4 md:col-span-1 flex flex-col items-center">
          <img className="w-[60px] h-[60px]" src="/public/image/Countup/mentor.png" alt="mentor" />
          <p className="font-bold text-2xl text-[var(--primary)]">
            {counterOn && (
